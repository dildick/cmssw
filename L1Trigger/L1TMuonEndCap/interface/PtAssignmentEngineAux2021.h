#ifndef L1TMuonEndCap_PtAssignmentEngineAux2021_h
#define L1TMuonEndCap_PtAssignmentEngineAux2021_h

#include "L1Trigger/L1TMuonEndCap/interface/PtAssignmentEngineAux.h"

class PtAssignmentEngineAux2021 : public PtAssignmentEngineAux {
public:
