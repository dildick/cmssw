...
int PtAssignmentEngineAux2021::getNLBdPhi(int dPhi, int bits, int max) const {
  ...
  return (sign_ * dPhi_);
}  // End function: int PtAssignmentEngineAux2021::getNLBdPhi()

int PtAssignmentEngineAux2021::getNLBdPhiBin(int dPhi, int bits, int max) const {
  emtf_assert((bits == 4 && max == 256) || (bits == 5 && max == 256) || (bits == 7 && max == 512));
  ...
  return (dPhiBin_);
}  // End function: int PtAssignmentEngineAux2021::getNLBdPhiBin()

int PtAssignmentEngineAux2021::getdPhiFromBin(int dPhiBin, int bits, int max) const {
  emtf_assert((bits == 4 && max == 256) || (bits == 5 && max == 256) || (bits == 7 && max == 512));
  ...
  return (dPhi_);
}  // End function: int PtAssignmentEngineAux2021::getdPhiFromBin()

int PtAssignmentEngineAux2021::getCLCT(int clct, int endcap, int dPhiSign, int bits) const {
  ...
  return clct_;
}  // End function: int PtAssignmentEngineAux2021::getCLCT()

int PtAssignmentEngineAux2021::unpackCLCT(int clct, int endcap, int dPhiSign, int bits) const {
  ...
  return clct_;
}  // End function: int PtAssignmentEngineAux2021::unpackCLCT()

int PtAssignmentEngineAux2021::getdTheta(int dTheta, int bits) const {
  emtf_assert(bits == 2 || bits == 3);
  ...
  return (dTheta_);
}  // End function: int PtAssignmentEngineAux2021::getdTheta()

int PtAssignmentEngineAux2021::unpackdTheta(int dTheta, int bits) const {
  emtf_assert(bits == 2 || bits == 3);
  ...
  return (dTheta_);
}  // End function: int PtAssignmentEngineAux2021::unpackdTheta(int dTheta, int bits)

int PtAssignmentEngineAux2021::getTheta(int theta, int st1_ring2, int bits) const {
  ...
  return (theta_);
}  // End function: int PtAssignmentEngineAux2021::getTheta()

void PtAssignmentEngineAux2021::unpackTheta(int& theta, int& st1_ring2, int bits) const {
...
}  // End function: void PtAssignmentEngineAux2021::unpackTheta()

int PtAssignmentEngineAux2021::unpackSt1Ring2(int theta, int bits) const {
  emtf_assert(bits == 4 || bits == 5);
  emtf_assert(theta >= 0 && theta < pow(2, bits));
...
}  // End function: void PtAssignmentEngineAux2021::unpackSt1Ring2()

int PtAssignmentEngineAux2021::get2bRPC(int clctA, int clctB, int clctC) const {
  int rpc_2b = -99;
  ...
  return (rpc_2b);
}  // End function: int PtAssignmentEngineAux2021::get2bRPC()

void PtAssignmentEngineAux2021::unpack2bRPC(int rpc_2b, int& rpcA, int& rpcB, int& rpcC) const {
  emtf_assert(rpc_2b >= 0 && rpc_2b < 4);
...
}  // End function: int PtAssignmentEngineAux2021::unpack2bRPC()

int PtAssignmentEngineAux2021::get8bMode15(
...
}  // End function: int PtAssignmentEngineAux2021::get8bMode15()

void PtAssignmentEngineAux2021::unpack8bMode15(int mode15_8b,
                                               int& theta,
                                               int& st1_ring2,
                                               int endcap,
                                               int sPhiAB,
...
}  // End function: void PtAssignmentEngineAux2021::unpack8bMode15()

// _____________________________________________________________________________
// From here down, code was originally in PtLUTVarCalc.cc

int PtAssignmentEngineAux2021::calcTrackTheta(const int th1,
                                              const int th2,
                                              const int th3,
                                              const int th4,
                                              const int st1_ring2,
...
void PtAssignmentEngineAux2021::calcDeltaPhis(int& dPh12,
                                              int& dPh13,
                                              int& dPh14,
                                              int& dPh23,
                                              int& dPh24,
...
}  // End function: void PtAssignmentEngineAux2021::calcDeltaPhis()

void PtAssignmentEngineAux2021::calcDeltaThetas(int& dTh12,
                                                int& dTh13,
                                                int& dTh14,
                                                int& dTh23,
                                                int& dTh24,
...
}  // End function: void PtAssignmentEngineAux2021::calcBends()

void PtAssignmentEngineAux2021::calcRPCs(int& RPC1,
                                         int& RPC2,
                                         int& RPC3,
                                         int& RPC4,
                                         const int mode,
...
}  // End function: void PtAssignmentEngineAux2021::calcRPCs()

int PtAssignmentEngineAux2021::calcBendFromPattern(const int pattern, const int endcap) const {
  int bend = -99;
  if (pattern < 0)
    return bend;
...
void PtAssignmentEngineAux2021::calcDeltaPhiSums(int& dPhSum4,
                                                 int& dPhSum4A,
                                                 int& dPhSum3,
                                                 int& dPhSum3A,
                                                 int& outStPh,
...
}  // End function: void PtAssignmentEngineAux2021::calcDeltaPhiSums()
