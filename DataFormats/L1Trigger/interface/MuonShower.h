...
namespace l1t {
  ...
  public:
    ...
    void setOneNominalInTime(const bool bit) { isOneNominalInTime_ = bit; mus0_ = bit;}
    void setOneNominalOutOfTime(const bool bit) { isOneNominalOutOfTime_ = bit; musOutOfTime0_ = bit;}
    void setTwoLooseInTime(const bool bit) { isTwoLooseInTime_ = bit; mus1_ = bit;}
    void setTwoLooseOutOfTime(const bool bit) { isTwoLooseOutOfTime_ = bit; musOutOfTime1_ = bit;}
