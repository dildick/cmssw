...
class MuonHitHelpers
{
  ...
  // return MuonType string for a particular DetId
  static std::string toGEMTypeString(int st, int ri);
  static std::string toRPCTypeString(int re, int st, int ri);
  static std::string toDTTypeString(int wh, int st);
  static std::string toCSCTypeString(int st, int ri);
